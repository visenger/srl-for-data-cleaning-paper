...
& \mathsf{\textsc{transaction}(\textsl{city}, \textsl{phone}, \textsl{street}_1)~\wedge~\textsc{transaction}(\textsl{city}, \textsl{phone}, \textsl{street}_2) }& \\
& \mathsf{ \Rightarrow \textsl{street}_1=\textsl{street}_2 }& \\
& \mathsf{2) ~\forall~\textsl{city}, \textsl{phone}, \textsl{zip}_1, \textsl{zip}_2 }& \\
& \mathsf{ ~\textsc{transaction}(\textsl{city}, \textsl{phone}, \textsl{zip}_1) \wedge~\textsc{transaction}(\textsl{city}, \textsl{phone}, \textsl{zip}_2) }& \\
