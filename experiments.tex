...
\todo[inline]{MSAG Experiment description: Dataset, pre-clustering, noise, results...Information completeness and data consistency interaction: see book p.171, p.173.. Application on Web/graph data. \cite{Chen2009extended} WE CAN MODEL ADDITIONAL KNOWLEDGE e.g build-in predicates }
