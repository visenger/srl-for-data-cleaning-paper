...
We conduct our experiments on real-life and synthetic data sets, which have also been used by previous work \cite{Dallachiesa:2013:NCD:2463676.2465327, chu2013holistic, llunaticVDLB2013b, bohannon2005cost}. 
...
This experiment tells us that applying on Web data, our method can produce good results on data with very little noise only, such as missing values. Yet extending data cleaning rules with domain specific information should be studied further in order to reduce false positives values in data repair. %\anno{I am in no way convinced that this is a good result... The majority of data points show a precision of less than 0.5... That means more than every second repair is wrong...} - fair enough! redone.
...
% \note{DONT MAKE READERS THINK: describe the result!} done.
...
%\note{DONT MAKE READERS THINK: explain exactly what they see in this figure!} done!
